...
var Logger = function () {
    ...
    _createClass(Logger, [{
        ...
        key: 'logDict',
        value: function logDict(name, dict, prefix, format) {
            dict = dict || {};
            ...
            try {
                for (var _iterator2 = Object.keys(dict)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        key: 'getWithPrefix',
        value: function getWithPrefix(prefix) {
            var _this = this;

            return {
                warn: function warn(msg) {
                    return _this.warn(msg, prefix);
                },
                log: function log(msg) {
                    return _this.log(msg, prefix);
                },
                info: function info(msg) {
                    return _this.info(msg, prefix);
                },
                error: function error(msg) {
                    return _this.error(msg, prefix);
                },
                logList: function logList(msg, list) {
                    return _this.logList(msg, list, prefix);
                },
                logDict: function logDict(msg, dict) {
                    return _this.logDict(msg, dict, prefix);
                }
            };
        }
    }, {
        key: '_getPrefix',
        value: function _getPrefix(moduleName) {
...
var Core = function () {
    function Core(data) {
        ...
        var moduleNames = [].concat(_toConsumableArray(this.moduleNames));
        ...
        try {
            for (var _iterator2 = moduleNames[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                var isMounted = this[moduleName].mount(data);
    ...
    _createClass(Core, [{
        ...
        key: '_unresgisterModule',
        value: function _unresgisterModule(module) {
            var moduleName = module.name;
            delete this[moduleName];

            var index = this.moduleNames.indexOf(moduleName);
        ...
        key: 'handle',
        value: function handle(eventName, handler) {
        ...
        key: 'asyncHandle',
        value: function asyncHandle(eventName, handler) {
        ...
        key: 'event',
        value: function event(eventName, data) {
            if (eventName in this.handlers) {
                ...
                try {
                    for (var _iterator3 = this.handlers[eventName][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        key: 'asyncEvent',
        value: function asyncEvent(eventName, data) {
            if (eventName in this.asyncHandlers) {
                return Promise.all(this.asyncHandlers[eventName].map(function (asyncHandler) {
        ...
        value: function about(logger) {
            ...
            try {
                for (var _iterator4 = this.moduleNames[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var Store = function () {
    function Store(core) {
        ...
        this.reducer = function (state, action) {
            ...
            try {
                for (var _iterator = _this.reducers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    _createClass(Store, [{
        ...
        value: function mount(data) {
            ...
            var config = data.store || {};
            this.initialState = config.initialState || this.initialState;
            this.middleware = [].concat(_toConsumableArray(this.middleware), _toConsumableArray(config.middleware || []));

            this.core.asyncHandle('beforeCreateElementOnServer', function (data) {
                data.props.store = _this2.createStore();
            });
        ...
        key: 'createStore',
        value: function createStore$$1() {
            var dataForStore = {
                reducer: this.reducer,
                preloadedState: this.initialState,
                enhancer: applyMiddleware.apply(undefined, _toConsumableArray(this.middleware))
            };

            this.core.event('beforeCreateStore', dataForStore);

            var store = createStore(dataForStore.reducer, dataForStore.preloadedState, dataForStore.enhancer);
        ...
        key: 'addReducer',
        value: function addReducer(reducer) {
...
var HelmetModule = function () {
    function HelmetModule(core) {
        _classCallCheck(this, HelmetModule);
    ...
    _createClass(HelmetModule, [{
        key: 'mount',
        value: function mount(data) {
            this.core.asyncHandle('afterRenderComponentOnServer', function (data) {
                data.helmet = Helmet_2.renderStatic();
            });
...
var Requests = function () {
    ...
    _createClass(Requests, [{
        ...
        key: 'path',
        value: function path(_path, data, headers) {
            return this.fetch('path', this._getURL(_path), data, headers);
        }
    }, {
        key: 'purge',
        value: function purge(path, data, headers) {
            return this.fetch('delete', this._getURL(path), data, headers);
        }
    }, {
        key: 'fetch',
        value: function fetch(method, url, body, headers, credentials) {
            var _this = this;

            headers = headers || {};

            var data = { method: method, url: url, headers: headers, body: body, credentials: credentials };

            if (this.middlewares.prepareData) {
                this.middlewares.prepareData(data);
            }

            return global.fetch(url, data).then(function (response) {
                if (_this.middlewares.prepareResult) {
                    return _this.middlewares.prepareResult(response);
                } else {
                    return response;
                }
            });
        ...
        key: '_urlIsAbsolute',
        value: function _urlIsAbsolute(url) {
            var re = /^https?:\/\/|^\/\//i;
            return re.test(url);
        }
    }]);
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 4;
                                return core.asyncEvent('beforeCreateElementOnServer', data);

                            case 4:
                                element = createElement(this.componentForSSR, data.props);
                                _context.next = 7;
                                return core.asyncEvent('beforeRenderComponentOnServer', data);

                            case 7:
                                data.html = renderToString(element);
                                _context.next = 10;
                                return core.asyncEvent('afterRenderComponentOnServer', data);
...
var AppsModule = function () {
    ...
    _createClass(AppsModule, [{
        ...
        value: function mount(data) {
            ...
            try {
                for (var _iterator = (data.apps || [])[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var app = _step.value;
            ...
            try {
                for (var _iterator2 = this.appNames[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var appName = _step2.value;
            ...
            core.handle('beforeCreateStore', function (data) {
                var _iteratorNormalCompletion3 = true;
                var _didIteratorError3 = false;
                var _iteratorError3 = undefined;

                try {
                    for (var _iterator3 = _this.appNames[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        var _appName = _step3.value;

                        if (_appName in data.preloadedState) {
                            continue;
                        }

                        data.preloadedState[_appName] = _extends$2({}, _this[_appName].initialState);
                    }
                } catch (err) {
                    _didIteratorError3 = true;
                    _iteratorError3 = err;
        ...
        key: '_registerApp',
        value: function _registerApp(App) {
            var instance = new App(this.core);
        ...
        key: '_addReducerInStore',
        value: function _addReducerInStore() {
            var _this2 = this;

            this.core.store.addReducer(function (state, action) {
                var _action$type$split = action.type.split('.'),
                    _action$type$split2 = _slicedToArray(_action$type$split, 3),
                    appName = _action$type$split2[0],
                    blockName = _action$type$split2[1],
                    actionName = _action$type$split2[2];

                if (!_this2.appNames.includes(appName)) {
                    return state;
                }

                var block = _this2._getBlock(appName, blockName);
                var originActionName = actionName.split('[')[0];
                ...
                if (block.index) {
                    // For dynamic blocks
                    var index = actionName.slice(actionName.indexOf('[') + 1, -1);

                    if (state[appName][blockName][index] === undefined) {
                        state[appName][blockName][index] = _extends$2({}, block.initialState);
                    }

                    var partState = state[appName][blockName][index];

                    var newPartState = block.reducer[originActionName](partState, action);

                    if (newPartState !== partState) {
                        state[appName][blockName] = _extends$2({}, state[appName][blockName], _defineProperty({}, index, newPartState));

                        return _extends$2({}, state);
                    }
                } else {
                    // For blocks
                    var _partState = state[appName][blockName];

                    var _newPartState = block.reducer[actionName](_partState, action);

                    if (_newPartState !== _partState) {
                        state[appName][blockName] = _newPartState;
                        return _extends$2({}, state);
                    }
                }
        ...
        key: '_getBlock',
        value: function _getBlock(appName, blockName) {
...
var BaseApp = function () {
    ...
    _createClass(BaseApp, [{
        ...
        value: function addValues(values) {
            BaseApp._updateDict(this.initialState, values);

            return this;
        }
    }, {
        key: 'addBlock',
        value: function addBlock(blockName, block) {
            block.index = undefined;
            return this._addBlock(blockName, block);
        }
    }, {
        key: 'addDynamicBlock',
        value: function addDynamicBlock(blockName, block) {
            return this._addBlock(blockName, block);
        }
    }, {
        key: '_addBlock',
        value: function _addBlock(blockName, block) {
            var _this = this;
            ...
            var _loop = function _loop(methodName) {
                _this[blockName][methodName] = function (params) {
                    return _this.getMethod(blockName, methodName, params);
                };
            };
            ...
            try {
                for (var _iterator = Object.keys(block.methods)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        key: 'getMethod',
        value: function getMethod(blockName, methodName, params) {
            var _this2 = this;

            var block = this._getBlock(blockName);
            ...
            return function (dispatch, getState) {
                var patchedDispatch = function patchedDispatch(type, payload) {
                    var newType = _this2._getActionType(blockName, type);
                ...
                var patchedGetState = function patchedGetState() {
                    var state = getState();
                    return state[_this2.name][blockName];
                };
        ...
        key: '_getBlock',
        value: function _getBlock(blockName) {
        ...
        key: '_getActionType',
        value: function _getActionType(blockName, type) {
            switch (type[0]) {
                case '^':
                    // Local
        ...
        key: '_updateDict',
        value: function _updateDict(first, second) {
...
var matchPath_1 = createCommonjsModule(function (module, exports) {

exports.__esModule = true;



var _pathToRegexp2 = _interopRequireDefault(pathToRegexp_1);
...
var matchPath = unwrapExports(matchPath_1);
...
var Router = unwrapExports(Router_1);
...
var _matchPath2 = _interopRequireDefault(matchPath_1);
...
var Route_1 = createCommonjsModule(function (module, exports) {
...
var Router$1 = function () {
    ...
    _createClass(Router, [{
        ...
        value: function mount(data) {
            ...
            core.asyncHandle('beforeRenderComponentOnServer', function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(data) {
                    var req, _req$url$split, _req$url$split2, path, search, matchingRoutes, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _ref2, route, match, props, componentWillRenderOnServer;
                    ...
                    return regenerator.wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    req = data.req;
                                    _req$url$split = req.url.split('?'), _req$url$split2 = _slicedToArray(_req$url$split, 2), path = _req$url$split2[0], search = _req$url$split2[1];
                                    matchingRoutes = matchRoutes(_this.routes, path);
                                    _iteratorNormalCompletion = true;
                                    _didIteratorError = false;
                                    _iteratorError = undefined;
                                    _context.prev = 6;
                                    _iterator = matchingRoutes[Symbol.iterator]();
                                ...
                                case 8:
                                    ...
                                    _ref2 = _step.value;
                                    route = _ref2.route, match = _ref2.match;
                                    props = _extends$2({}, data.props, {
                                        match: match.params,
                                        location: {
                                            path: path,
                                            search: search || ''
                                    ...
                                    _context.next = 14;
                                    return core.asyncEvent('componentWillRenderOnServer', props);

                                case 14:
                                    componentWillRenderOnServer = route.component.componentWillRenderOnServer;
                                    ...
                                    _context.next = 18;
                                    return componentWillRenderOnServer(core, props);
                    ...
                    }, _callee, _this, [[6, 23, 27, 35], [28,, 30, 34]]);
                }));
            ...
            core.asyncHandle('afterRenderComponentOnServer', function (data) {
                var res = data.res,
                    props = data.props;
                ...
                var status = props.context.status || 200;
                res.status(status);
            });
